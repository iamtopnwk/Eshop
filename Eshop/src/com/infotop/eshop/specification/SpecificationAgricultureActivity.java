...
public class SpecificationAgricultureActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_specification_agriculture);
	 ...
	 AsyncTask<String, Void, String> productSpec = new GetOperation().execute(serverURL);
		...
		try {
			...
			TextView txt1=(TextView)findViewById(R.id.publisher_agriculture);
			TextView txt2=(TextView)findViewById(R.id.edition_agriculture);
			TextView txt3=(TextView)findViewById(R.id.isbn_agriculture);
			TextView txt4=(TextView)findViewById(R.id.binding_agriculture);
			TextView txt5=(TextView)findViewById(R.id.author_agriculture);
			TextView txt6=(TextView)findViewById(R.id.exam_agriculture);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.specification_agriculture, menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.home_agriculture:
			Intent intent=new Intent(SpecificationAgricultureActivity.this,EshopMainActivity.class);
