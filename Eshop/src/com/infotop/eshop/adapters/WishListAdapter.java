...
public class WishListAdapter extends ArrayAdapter<String> {
	...
	WishListAdapter myadapter;
		...
		public WishListAdapter(Activity context,String[] productId,String[] productName,
				String[] imageUrl, String[] desc, String[] price,DisplayImageOptions op) {
		...
		public View getView(int position, View view, ViewGroup parent) {
			...
			if (rowView == null) {
				rowView = context.getLayoutInflater().inflate(
						R.layout.wish_list, parent, false);
	                	...
	                	alertDialog.setPositiveButton("YES",
	        					new DialogInterface.OnClickListener() {
	        						public void onClick(DialogInterface dialog,int which) {
	        							...
	        							System.out.println("mmmmmmmmmmmm"+context);
	        							List<Wishlist> wishListItems = db.getAllWishListItems();
	        							//Integer.parseInt("w.getProductId()");
	        							db.deleteWishListItem(productId[positionId]);
	        							
	        							System.out.println("jjjjjjjjjjjjjjjjjjjjjjjj"+productId[positionId]);
	        							
	        						
	        							System.out.println("po000spppppppppp"+positionId);
	        							
	        							
	        							((Activity)context).finish();
	        							Intent intent = new Intent(context, WishListMainActivity.class);
